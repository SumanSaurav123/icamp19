...
Hello, {{ $data['name'] }}
<br>
Thank you for participating in the Internship Camp.
<br><br>
Please use the give link to change your password.
<br>
<br>
Please Click <b><a href="http:icamp19/resetPassword/{{ $data['token'] }} ">here</a></b><br>
